        ...
        <section class="col-span-8 col-start-5 mt-10">
            ...
            @auth
                <form method="POST" action="/post/{{ $post->slug }}/comments" class="bg-gray-100 p-6 mb-4 rounded-xl border border-gray-200">
                    ...
                    <div class="mt-6">
                        <textarea class="w-full text-sm p-2 bg-gray-100 focus:outline-none focus:ring" name="body" id="comment" placeholder="Quick, think of something to say..." cols="30" rows="5" ></textarea>
                    </div>
